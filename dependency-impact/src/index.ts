 ...
 */
function buildReviewBody(assessment: DependencyAssessment): string {
...
function buildInlineComments(
  ...
  for (const annotation of assessment.inlineAnnotations) {
    ...
    // Find the manifest file in the PR that contains this dependency's version change
    for (const file of prFiles) {
      ...
      if (line != null && line > 0) {
        ...
        break; // one comment per dependency
      }
    }
  }
